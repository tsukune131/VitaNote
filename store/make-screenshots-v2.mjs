/**
 * App Store 用のスクリーンショットを組み立てる(POP版・6枚)。
 *
 *   node store/make-screenshots-v2.mjs
 *
 ...
 *
 * 既存の store/screenshots/ は審査に出した組のままにしてあるので、
 * ここでは別のディレクトリに書き出す。差し替えるかは見てから決める。
 */
...
const SIZES = [
  { W: 1320, H: 2868, dir: 'store/screenshots-v2' },
  { W: 1284, H: 2778, dir: 'store/screenshots-v2-65' },
];
